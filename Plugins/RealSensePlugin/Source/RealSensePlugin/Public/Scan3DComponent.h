...
public:
	// 3d Scan mode 
	UPROPERTY(BlueprintReadOnly, EditAnywhere, Category = "RealSense|Scan3D")
	EScan3DMode ScanMode = EScan3DMode::FACE;

	// Generate a closed manifold mesh.
	UPROPERTY(BlueprintReadOnly, EditAnywhere, Category = "RealSense|Scan3D")
	bool Solidification = true;

	// Disable vertex color, and generate texture map (meshBaseNameImage1.jpg),and material (meshBaseName.mtl) files.	
	UPROPERTY(BlueprintReadOnly, EditAnywhere, Category = "RealSense|Scan3D")
	bool GenTexture	= true;	

	// Use face module to track and generate mesh relative landmark data (meshBaseName.json).
	UPROPERTY(BlueprintReadOnly, EditAnywhere, Category = "RealSense|Scan3D")
	bool GenLandmarkPoint = true;
	...
	// has started.
	UPROPERTY(BlueprintReadOnly, Category = "RealSense|Scan3D") 
	...
	UPROPERTY(BlueprintAssignable, Category = "RealSense|Scan3D") 
	...
	UFUNCTION(BlueprintCallable, Category = "RealSense|Scan3D") 
	...
	UFUNCTION(BlueprintCallable, BlueprintPure, Category = "RealSense|Scan3D") 
	bool IsScanning();
